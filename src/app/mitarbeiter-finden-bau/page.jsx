    ...
    try {
      await fetch("/api/leadmagnet-capture", {
        ...
        body: JSON.stringify({
          ...
          industry: "Bau & Ausbau",
          extra: { branche: "Bau & Ausbau", pageType: "branchen-landing" },
        }),
      });
      ...
      <div style={{ background: `linear-gradient(135deg, ${D} 0%, ${B} 50%, #0A4D72 100%)`, padding: mob ? "48px 16px 56px" : "80px 24px 88px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <h1 style={{ color: W, fontSize: mob ? 26 : 42, fontWeight: 800, margin: "0 0 16px", lineHeight: 1.2 }}>
            Mitarbeiter Bau gesucht — Maurer, Zimmerer & Bauleiter finden
          </h1>
          ...
          <p style={{ color: `${W}50`, fontSize: 13, marginTop: 10 }}>20 Min. · Unverbindlich · Konkrete Strategie für Bau & Ausbau</p>
        </div>
      </div>
      ...
      <div style={{ background: L, padding: mob ? "32px 16px 48px" : "56px 24px 72px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr 1fr" : "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 32 }}>
            ...
            <Stat n="155 Tage" label="Ø Vakanzzeit" color={R} />
            <Stat n="16-24 €" label="Kosten/Bewerbung" color={G} />
            <Stat n="Ø 30 Tage" label="Bis zur Einstellung" />
          </div>
          ...
          <div style={{ background: W, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: B, fontSize: mob ? 20 : 26, fontWeight: 700, margin: "0 0 14px" }}>
              🏗️ Die Situation in der Hoch-, Tief- und Ausbaugewerbe
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 16px" }}>
              Der Bau boomt — Infrastruktur, Wohnungsbau, Sanierung. Aber die Kapazitäten fehlen. 62% der Baubetriebe müssen Aufträge ablehnen, weil sie nicht genug Personal haben.
            </p>
            <div style={{ padding: "14px 16px", background: i === 0 ? `${R}05` : `${L}`, border: `1px solid ${i === 0 ? R + "15" : "#E2E8F0"}`, borderRadius: 10, marginBottom: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🔴</strong> Auftragsstau: Volle Auftragsbücher, aber keine Hände. Bauprojekte verzögern sich um Monate, Vertragsstrafen drohen.</p>
            </div>
            <div style={{ padding: "14px 16px", background: i === 0 ? `${R}05` : `${L}`, border: `1px solid ${i === 0 ? R + "15" : "#E2E8F0"}`, borderRadius: 10, marginBottom: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🟡</strong> Saisonalität: Die Abhängigkeit von Wetter und Saison macht langfristige Personalplanung zusätzlich schwierig.</p>
            </div>
            <div style={{ padding: "14px 16px", background: i === 0 ? `${R}05` : `${L}`, border: `1px solid ${i === 0 ? R + "15" : "#E2E8F0"}`, borderRadius: 10, marginBottom: 0 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🟠</strong> Körperliche Belastung: Der Beruf gilt als anstrengend — umso wichtiger ist es, mit modernen Bedingungen zu werben.</p>
            </div>
          </div>
          ...
          <div style={{ background: `${R}05`, border: `1px solid ${R}15`, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24 }}>
            <h2 style={{ color: B, fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 12px" }}>
              ❌ Warum Jobbörsen im Bau & Ausbau nicht mehr funktionieren
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>
              Bauarbeiter und Handwerker sind nach Feierabend auf Social Media, nicht auf Jobbörsen. Mit einer zielgerichteten Facebook-Kampagne erreichen Sie sie genau in dem Moment, wo sie offen für neue Angebote sind.
            </p>
          </div>
          ...
          <div style={{ background: W, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: B, fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 14px" }}>
              ✅ Social Recruiting für Bau & Ausbau: So funktioniert's
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 16px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : "1fr 1fr 1fr", gap: 12 }}>
              {[
                { icon: "🎯", t: "Gezielte Ansprache", d: "Wir erreichen Maurer im Umkreis von 30km — nach Beruf, Alter und Interessen." },
          ...
          <div style={{ background: `${G}08`, border: `1px solid ${G}20`, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24 }}>
            ...
            <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.7, margin: 0 }}>
              Ein Bauunternehmen aus Sachsen-Anhalt suchte 5 Monate einen Polier. Über Social Recruiting: 19 Bewerbungen in 3 Wochen, 1 Einstellung nach 22 Tagen.
            </p>
          </div>
          ...
          <div style={{ background: W, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: B, fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 14px" }}>
              Diese Positionen besetzen wir im Bau & Ausbau
            </h2>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {["Maurer/in","Zimmerer/in","Betonbauer/in","Trockenbauer/in","Bauleiter/in"].map((p, i) => (
          ...
          <div style={{ background: W, borderRadius: 16, padding: mob ? "20px 18px" : "28px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            ...
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>
              Die Ergebnisse sprechen für sich: 16-24 € pro qualifizierte Bewerbung, 10-14% Conversion-Rate und durchschnittlich 30 Tage bis zur Einstellung. Deutlich schneller und kostengünstiger als traditionelle Wege über Jobbörsen, Zeitungsanzeigen oder Personalvermittler.
            </p>
          </div>
