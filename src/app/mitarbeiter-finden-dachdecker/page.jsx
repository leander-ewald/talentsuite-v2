      ...
      <div style={{ background: `linear-gradient(135deg, ${D} 0%, ${B} 50%, #0A4D72 100%)`, padding: mob ? "48px 16px 56px" : "80px 24px 88px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <h1 style={{ color: W, fontSize: mob ? 26 : 42, fontWeight: 800, margin: "0 0 16px", lineHeight: 1.2 }}>
            Dachdecker gesucht — Dachdeckerfachkräfte finden in 30 Tagen
          </h1>
          ...
          <p style={{ color: `${W}50`, fontSize: 13, marginTop: 10 }}>20 Min. · Unverbindlich · Konkrete Strategie für Dachdeckerhandwerk</p>
        </div>
      </div>
      ...
      <div style={{ background: L, padding: mob ? "32px 16px 48px" : "56px 24px 72px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr 1fr" : "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 32 }}>
            <Stat n="12.000+" label="Offene Stellen" />
            <Stat n="160 Tage" label="Ø Vakanzzeit" color={R} />
            <Stat n="17-25 €" label="Kosten/Bewerbung" color={G} />
          ...
          <div style={{ background: W, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: B, fontSize: mob ? 20 : 26, fontWeight: 700, margin: "0 0 14px" }}>
              🏠 Die Situation in der Dachdeckerei, Klempnerei und Zimmerei
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 16px" }}>
              Das Dachdeckerhandwerk gehört zu den am stärksten vom Fachkräftemangel betroffenen Gewerken. Die Kombination aus körperlicher Arbeit, Höhenarbeit und Witterungsabhängigkeit macht es besonders schwer, Nachwuchs zu gewinnen.
            </p>
            ...
            <div style={{ padding: "14px 16px", background: i === 0 ? `${R}05` : `${L}`, border: `1px solid ${i === 0 ? R + "15" : "#E2E8F0"}`, borderRadius: 10, marginBottom: 0 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🟠</strong> Kleine Betriebsgrößen: Die meisten Dachdeckerbetriebe haben unter 10 Mitarbeiter und keine HR-Abteilung für professionelles Recruiting.</p>
            </div>
          </div>
          ...
          <div style={{ background: `${R}05`, border: `1px solid ${R}15`, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24 }}>
            <h2 style={{ color: B, fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 12px" }}>
              ❌ Warum Jobbörsen im Dachdeckerhandwerk nicht mehr funktionieren
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>
              Dachdecker suchen nicht auf LinkedIn. Sie sind auf Facebook und YouTube unterwegs. Mit authentischen Videos vom Dach und ehrlichen Team-Einblicken gewinnen Sie genau die Fachkräfte, die zu Ihrem Betrieb passen.
            </p>
          </div>
          ...
          <div style={{ background: W, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: B, fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 14px" }}>
              ✅ Social Recruiting für Dachdeckerhandwerk: So funktioniert's
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 16px" }}>
          ...
          <div style={{ background: `${G}08`, border: `1px solid ${G}20`, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24 }}>
            ...
            <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.7, margin: 0 }}>
              Ein Dachdeckerbetrieb aus dem Rheinland suchte 9 Monate einen Gesellen. Über Social Media: 12 Bewerbungen in 3 Wochen, 1 Einstellung. Kosten: unter 2.000 €.
            </p>
          </div>
          ...
          <div style={{ background: W, borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: B, fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 14px" }}>
              Diese Positionen besetzen wir im Dachdeckerhandwerk
            </h2>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {["Dachdecker/in","Spengler/in","Dachdeckermeister/in","Zimmerer/in (Dachstuhl)","Auszubildende/r Dachdecker"].map((p, i) => (
          ...
          <div style={{ background: W, borderRadius: 16, padding: mob ? "20px 18px" : "28px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            ...
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>
              Die Ergebnisse sprechen für sich: 17-25 € pro qualifizierte Bewerbung, 10-14% Conversion-Rate und durchschnittlich 32 Tage bis zur Einstellung. Deutlich schneller und kostengünstiger als traditionelle Wege über Jobbörsen, Zeitungsanzeigen oder Personalvermittler.
            </p>
          </div>
