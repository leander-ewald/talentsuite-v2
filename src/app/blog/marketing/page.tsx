        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-12">
              <img src="/assets/Marketing.png" className="blog_img" alt="Marketing image" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2 className="text-3xl font-bold mb-6">Wie eine Digitalagentur Ihr Unternehmen voranbringen kann</h2>
