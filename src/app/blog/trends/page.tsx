        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-12">
              <img src="/assets/Trends.png" className="blog_img" alt="Trends image" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2 className="text-3xl font-bold mb-6">Die neuesten Trends und Strategien mit einer Digitalagentur</h2>
              ...
              <div className="mb-6">
                ...
                <p className="text-sm">
                  Talentsuite erbringt individuelle Dienstleistungen im Bereich digitales Trends, Webentwicklung und E-Commerce. Der genaue Leistungsumfang wird im jeweiligen Angebot definiert.
                </p>
              </div>
