...
const positionen = [{"name":"Koch/Köchin","slug":"gastro","stellen":"38.000","cpa":"10-18€"},{"name":"Servicekraft","slug":"gastro","stellen":"31.000","cpa":"8-15€"},{"name":"Hotelfachkraft","slug":"gastro","stellen":"18.000","cpa":"12-20€"}];
...
export default function GastronomieHub() {
  ...
  return (
    <>
      <Head>
        <title>Gastro-Personal finden — Performance Recruiting für Gastronomie und Hotellerie | TalentSuite</title>
        <meta name="description" content="Performance Recruiting für Gastronomie und Hotellerie. Qualifizierte Bewerbungen ab 15€ über Social Media." />
      </Head>
      <div style={{ background: "#f0f4f7", minHeight: "100vh" }}>
        <div style={{ background: "linear-gradient(135deg, #011E2F 0%, #023B5B 50%, #0A4D72 100%)", padding: mob ? "48px 16px 56px" : "72px 24px 80px", textAlign: "center" }}>
          ...
          <h1 style={{ color: "#ffffff", fontSize: mob ? 26 : 40, fontWeight: 800, margin: "0 0 12px", lineHeight: 1.15 }}>
            Gastro-Personal finden — <span style={{ color: "#1B98E0" }}>Performance Recruiting für Gastronomie und Hotellerie</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: mob ? 15 : 18, maxWidth: 540, margin: "0 auto" }}>Die Gastronomie hat ein Image-Problem beim Recruiting — Social Media ist die Lösung.</p>
        </div>
