 ...
 * id="tb" + data-tb attributes → color overrides in globals.css
 * All layout via wrapper divs to avoid global section styles
 */
  ...
  return (
    <>
      ...
      <div id="tb">
        ...
        {/* ══════════ HERO ══════════ */}
        <div className="tb-section" style={{ textAlign: "center", paddingTop: 60, paddingBottom: 40 }}>
          <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
            ...
            <p data-tb="muted" style={{ marginTop: 16 }}>
        ...
        {/* ══════════ STEPS HEADING ══════════ */}
        <div className="tb-section" style={{ textAlign: "center", paddingBottom: 32 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 32 }}>
                {[
                  ...
                  <div key={i} style={{ textAlign: "center" }}>
                    ...
                    <h3>{step.title}</h3>
                    <p data-tb="body" style={{ marginTop: 8 }}>{step.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="tb-section" style={{ paddingBottom: 60 }}>
          <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
            <div style={{
              ...
              <h2 style={{ textAlign: "center", marginBottom: 28 }}>Was Sie in der Analyse erwartet</h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16, textAlign: "center" }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div data-tb="accent" style={{ fontWeight: 800, marginBottom: 6 }} className="tb-stat-val">
                    {stat.value}
                  </div>
        ...
        {/* ══════════ ROBERT ENGEL ══════════ */}
        <div className="tb-section" style={{ textAlign: "center", paddingBottom: 60 }}>
          <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
            <p data-tb="white" style={{ fontWeight: 600 }}>
              Robert Engel · Geschäftsführer TalentSuite
            </p>
            <p data-tb="muted" style={{ marginTop: 8 }}>
        ...
        {/* ══════════ CTA ══════════ */}
        <div className="tb-section" style={{ textAlign: "center", padding: "60px 24px" }}>
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            <h2 data-tb="white">Bereit für messbares Wachstum?</h2>
            <p data-tb="muted" style={{ marginTop: 14, marginBottom: 28 }}>
            ...
            <p data-tb="muted" style={{ marginTop: 16, opacity: 0.6 }}>
