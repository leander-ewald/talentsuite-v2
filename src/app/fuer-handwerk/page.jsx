...
const positionen = [{"name":"SHK","slug":"shk","stellen":"32.000","cpa":"15-22€"},{"name":"Elektro","slug":"elektro","stellen":"28.000","cpa":"16-24€"},{"name":"Bau","slug":"bau","stellen":"41.000","cpa":"14-20€"},{"name":"Maler","slug":"maler","stellen":"15.000","cpa":"12-18€"},{"name":"Dachdecker","slug":"dachdecker","stellen":"9.000","cpa":"14-22€"},{"name":"KFZ","slug":"kfz","stellen":"24.000","cpa":"16-25€"}];
...
export default function HandwerkHub() {
  ...
  return (
    <>
      <Head>
        <title>Fachkräfte fürs Handwerk — Performance Recruiting für Handwerksbetriebe | TalentSuite</title>
        <meta name="description" content="Performance Recruiting für Handwerksbetriebe. Qualifizierte Bewerbungen ab 15€ über Social Media." />
      </Head>
      <div style={{ background: "#f0f4f7", minHeight: "100vh" }}>
        <div style={{ background: "linear-gradient(135deg, #011E2F 0%, #023B5B 50%, #0A4D72 100%)", padding: mob ? "48px 16px 56px" : "72px 24px 80px", textAlign: "center" }}>
          ...
          <h1 style={{ color: "#ffffff", fontSize: mob ? 26 : 40, fontWeight: 800, margin: "0 0 12px", lineHeight: 1.15 }}>
            Fachkräfte fürs Handwerk — <span style={{ color: "#1B98E0" }}>Performance Recruiting für Handwerksbetriebe</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: mob ? 15 : 18, maxWidth: 540, margin: "0 auto" }}>178.000 offene Stellen im Handwerk — und klassische Jobbörsen erreichen nur 28% des Marktes.</p>
        </div>
