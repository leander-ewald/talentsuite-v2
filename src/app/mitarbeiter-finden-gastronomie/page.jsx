      ...
      <div className="bp-hero" style={{ background: "linear-gradient(135deg, #011E2F 0%, #023B5B 50%, #0A4D72 100%)", padding: mob ? "48px 16px 56px" : "80px 24px 88px", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <h1 style={{ color: "#ffffff", fontSize: mob ? 26 : 42, fontWeight: 800, margin: "0 0 16px", lineHeight: 1.2 }}>
            Personal Gastronomie finden — Köche & Servicekräfte in 30 Tagen
          </h1>
          ...
          <p className="bp-hero-hint" style={{ color: "rgba(255,255,255,0.5)", fontSize: 13, marginTop: 10 }}>20 Min. · Unverbindlich · Konkrete Strategie für Gastronomie & Hotellerie</p>
        </div>
      </div>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 20 : 26, fontWeight: 700, margin: "0 0 14px" }}>
              🍽️ Die Situation in der Gastronomie und Hotellerie
            </h2>
            ...
            <div className="bp-pain-box" style={{ padding: "14px 16px", background: "rgba(239,68,68,0.05)", border: "1px solid rgba(239,68,68,0.15)", borderRadius: 10, marginBottom: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🔴</strong> Post-COVID-Exodus: 275.000 Fachkräfte haben die Gastronomie seit 2020 dauerhaft verlassen — sie kommen nicht zurück.</p>
            </div>
            <div className="bp-pain-box" style={{ padding: "14px 16px", background: "#f0f4f7", border: "1px solid #E2E8F0", borderRadius: 10, marginBottom: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🟡</strong> Eingeschränkter Betrieb: 58% der Gastrobetriebe können ihr Angebot nicht mehr vollständig aufrechterhalten.</p>
            </div>
            <div className="bp-pain-box" style={{ padding: "14px 16px", background: "#f0f4f7", border: "1px solid #E2E8F0", borderRadius: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🟠</strong> Arbeitszeiten-Problem: Abend-, Wochenend- und Feiertagsarbeit schreckt viele potenzielle Bewerber ab.</p>
            </div>
          </div>
          ...
          <div className="bp-fail" style={{ background: "rgba(239,68,68,0.05)", border: "1px solid rgba(239,68,68,0.15)", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24 }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 12px" }}>
              ❌ Warum Jobbörsen im Bereich Gastronomie & Hotellerie nicht mehr funktionieren
            </h2>
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 14px" }}>
              ✅ Social Recruiting für Gastronomie & Hotellerie: So funktioniert es
            </h2>
            <p className="bp-pain-intro" style={{ margin: "0 0 16px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : "1fr 1fr 1fr", gap: 12 }}>
              {[
                { icon: "🎯", t: "Gezielte Ansprache", d: "Wir erreichen Köche und Servicekräfte im Umkreis von 30km — nach Beruf, Alter und Interessen." },
                ...
                { icon: "📊", t: "Messbare Ergebnisse", d: "12-18 € pro Bewerbung bei 15-20% Conversion. Transparent und nachvollziehbar." },
              ].map((s, idx) => (
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 14px" }}>
              Diese Positionen besetzen wir im Bereich Gastronomie & Hotellerie
            </h2>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {["Koch (m/w/d)","Servicekraft","Küchenchef","Restaurantfachmann/-frau","Hotelfachkraft"].map((p, idx) => (
          ...
          <div className="bp-seo" style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "20px 18px" : "28px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 12px" }}>So gewinnen erfolgreiche Gastrobetriebe heute Fachkräfte</h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 12px" }}>Der Fachkräftemangel in der Gastronomie ist strukturell und hat sich durch die Pandemie massiv verschärft.</p>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 12px" }}>Erfolgreiche Betriebe gehen aktiv auf potenzielle Kandidaten zu, statt zu warten.</p>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>Die Ergebnisse: 12-18 € pro qualifizierte Bewerbung, 15-20% Conversion-Rate, Ø 25 Tage bis Einstellung.</p>
          </div>
          ...
          <div className="bp-cta" style={{ background: "linear-gradient(135deg, #011E2F, #023B5B)", borderRadius: 16, padding: mob ? "32px 18px" : "44px 32px", textAlign: "center" }}>
            <h2 style={{ color: "#ffffff", fontSize: mob ? 22 : 30, fontWeight: 800, margin: "0 0 10px" }}>Koch oder Servicekraft gesucht?</h2>
