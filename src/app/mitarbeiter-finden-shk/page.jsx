  ...
  const submit = async () => {
    ...
    try {
      await fetch("/api/leadmagnet-capture", {
        ...
        body: JSON.stringify({
          source: "mitarbeiter-finden-shk", name: form.name, email: form.email,
          phone: form.phone || undefined, company: form.company || undefined,
          industry: "SHK-Handwerk",
          extra: { branche: "SHK-Handwerk", pageType: "branchen-landing" },
        }),
      });
      ...
      <div className="bp-hero" style={{ background: "linear-gradient(135deg, #011E2F 0%, #023B5B 50%, #0A4D72 100%)", padding: mob ? "48px 16px 56px" : "80px 24px 88px", position: "relative", overflow: "hidden" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          <h1 style={{ color: "#ffffff", fontSize: mob ? 26 : 42, fontWeight: 800, margin: "0 0 16px", lineHeight: 1.2 }}>
            SHK Fachkräfte finden — Anlagenmechaniker & Monteure in 30 Tagen
          </h1>
          <p className="bp-hero-sub" style={{ color: "rgba(255,255,255,0.8)", fontSize: mob ? 15 : 19, maxWidth: 620, margin: "0 auto 24px", lineHeight: 1.6 }}>
            68.000+ offene Stellen · Ø 165 Tage Vakanzzeit · 72% der Fachkräfte nicht auf Jobbörsen
          </p>
          ...
          <p className="bp-hero-hint" style={{ color: "rgba(255,255,255,0.5)", fontSize: 13, marginTop: 10 }}>20 Min. · Unverbindlich · Konkrete Strategie für SHK-Handwerk</p>
        </div>
      </div>
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            ...
            <div style={{ padding: "14px 16px", background: "rgba(239,68,68,0.05)", border: "1px solid rgba(239,68,68,0.15)", borderRadius: 10, marginBottom: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🔴</strong> Wärmepumpen-Boom: Die Nachfrage nach Installateuren hat sich verdreifacht — 62% der Betriebe lehnen bereits Aufträge ab.</p>
            </div>
            <div style={{ padding: "14px 16px", background: "#f0f4f7", border: "1px solid #E2E8F0", borderRadius: 10, marginBottom: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🟡</strong> Überalterung: Der Altersdurchschnitt im SHK-Handwerk steigt kontinuierlich. Viele erfahrene Monteure gehen in den nächsten Jahren in Rente.</p>
            </div>
            <div style={{ padding: "14px 16px", background: "#f0f4f7", border: "1px solid #E2E8F0", borderRadius: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🟠</strong> Konkurrenz durch Industrie: Große Hersteller werben SHK-Fachkräfte mit höheren Gehältern und geregelten Arbeitszeiten ab.</p>
            </div>
          </div>
          ...
          <div className="bp-fail" style={{ background: "rgba(239,68,68,0.05)", border: "1px solid rgba(239,68,68,0.15)", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24 }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 12px" }}>
              ❌ Warum Jobbörsen im Bereich SHK-Handwerk nicht mehr funktionieren
            </h2>
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 14px" }}>
              ✅ Social Recruiting für SHK-Handwerk: So funktioniert es
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 16px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr" : "1fr 1fr 1fr", gap: 12 }}>
              {[
                { icon: "🎯", t: "Gezielte Ansprache", d: "Wir erreichen Anlagenmechaniker im Umkreis von 30km — nach Beruf, Alter und Interessen." },
                ...
                { icon: "📊", t: "Messbare Ergebnisse", d: "15-22 € pro Bewerbung bei 12-18% Conversion. Transparent und nachvollziehbar." },
              ].map((s, idx) => (
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 14px" }}>
              Diese Positionen besetzen wir im Bereich SHK-Handwerk
            </h2>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {["Anlagenmechaniker SHK (m/w/d)","Kundendiensttechniker","Gas-Wasser-Installateur","Heizungsbauer","SHK-Meister"].map((p, idx) => (
          ...
          <div className="bp-seo" style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "20px 18px" : "28px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 12px" }}>So gewinnen erfolgreiche SHK-Betriebe heute Fachkräfte</h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 12px" }}>Der Fachkräftemangel im SHK-Handwerk ist keine vorübergehende Erscheinung — er ist strukturell und wird sich durch die Energiewende weiter verschärfen.</p>
            ...
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>Die Ergebnisse sprechen für sich: 15-22 € pro qualifizierte Bewerbung, 12-18% Conversion-Rate und durchschnittlich 28 Tage bis zur Einstellung.</p>
          </div>
          ...
          <div className="bp-cta" style={{ background: "linear-gradient(135deg, #011E2F, #023B5B)", borderRadius: 16, padding: mob ? "32px 18px" : "44px 32px", textAlign: "center" }}>
            <h2 style={{ color: "#ffffff", fontSize: mob ? 22 : 30, fontWeight: 800, margin: "0 0 10px" }}>Anlagenmechaniker gesucht?</h2>
