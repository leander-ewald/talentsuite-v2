...
export default function Danke() {
  ...
  return (
    <>
      <Head><title>Danke — Gehalts-Benchmark | TalentSuite</title></Head>
      <div style={{ background: "#f0f4f7", minHeight: "100vh" }}>
        <div style={{ background: "linear-gradient(135deg, #011E2F 0%, #023B5B 50%, #0A4D72 100%)", padding: mob ? "64px 16px 72px" : "96px 24px 104px", textAlign: "center" }}>
          ...
          <h1 style={{ color: "#ffffff", fontSize: mob ? 24 : 36, fontWeight: 800, margin: "0 0 12px", lineHeight: 1.15 }}>Ihr Benchmark ist unterwegs!</h1>
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: mob ? 15 : 18, maxWidth: 520, margin: "0 auto" }}>Prüfen Sie Ihr Postfach — Ihre Gehaltsdaten kommen sofort.</p>
        </div>
